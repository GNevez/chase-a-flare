...
const Navbar = () => {
  ...
  const navItems = [
    ...
    {
      name: "2 por R$199,00",
      href: "/collections/chase-a-flare",
    },
    {
      name: "Coleções",
      href: "/collections",
    ...
    { name: "Guia de rosto", href: "/guia-de-rosto" },
  ...
  return (
    <>
      ...
      >
        <div
          className={`hidden md:block w-full transition-all duration-500 ease-out ${
            currUrl === "/" && !isScrolled
                  ...
                  <div key={item.name} className="relative group">
                    {item.dropdown ? (
                      <>
                        <Link
                          href={item.href}
                          className="text-foreground hover:text-accent transition-smooth font-medium relative group flex items-center gap-1"
                        >
                          {item.name}
                      ...
                      {item.dropdown ? (
                        <div>
                          <div className="flex items-center justify-between">
                            <Link
                              href={item.href}
                              className="flex-1 text-foreground hover:text-accent transition-smooth font-medium py-3"
                            ...
                            <button
                              ...
                              className="px-3 py-3 text-foreground hover:text-accent transition-smooth"
                            >
                              <ChevronDown
